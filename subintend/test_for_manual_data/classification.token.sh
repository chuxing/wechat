...
${FASTTEXT_BIN} supervised -input "fast.train" -output "fast.model" -dim 30 -lr 0.015 -wordNgrams 3 -minCount 6 -bucket 100000 -epoch 50 -thread 8 -loss softmax
...
python ./record_errors.py ./fast.test.predict ./fast.test "record_flip_label_data.txt" "record_flip_label_data.txt"
